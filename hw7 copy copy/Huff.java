...
public class Huff {
    ...
    /** Sets the various global filenames.g
      * 
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Instead of code file, writes to beginning of .huff file
        PrintStream preamble = new PrintStream(outputFileName);
        tree.write(preamble, count);
